...
from src import workflow_runner
from src.models import MyException, Configuration, Index
...
async def uvicorn_exception_handler(request: Request, exc: MyException):
    return JSONResponse(
        status_code=418,
        content={"message": f"Error occurred! Please contact with system admin!"}
    )
